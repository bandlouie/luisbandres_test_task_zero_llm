...
with gr.Blocks() as demo:
    with gr.Row():
        with gr.Column():
            ...
            <ol>
                ...
                <li><strong>Step 7: Additional Task. Use Fine-Tuned Model</strong> - This step outlines a methodology for retraining a Davinci Model (GPT-3.5) using OpenAI CLI, based on the training samples collected during Step 4.
                    <ul>
    ...
    with gr.Row():
        with gr.Column():
            ...
            during STEP 4.</p>
            <p align="justify">The strategy is engineered to fine-tune the Davinci Model (GPT-3.5), aiming to internalize the repetitive task of applying
